<button id="infoBtn"
    class="absolute top-4 right-4 h-8 w-8 flex items-center justify-center rounded-full bg-white text-gray-700 shadow-md hover:shadow-lg transition-shadow">
...
<div id="infoModal" class="modal fixed inset-0 flex items-center justify-center z-50">
    ...
    <div
        class="modal-content bg-white modal-size mx-4 rounded-lg shadow-lg z-50 transform scale-100 transition-transform duration-300">

        <button id="closeBtn"
            class="h-8 w-8 flex items-center justify-center rounded-full text-gray-500 hover:text-gray-700 absolute top-0 right-0 transition-colors">
        ...
        <div class="modal-body pl-3 pr-3 pb-3">
            <div class="p-2 overflow-y-auto flex flex-col justify-between">
                <h3 class="font-bold text-center mt-2 modal-title text-gray-700">เกี่ยวกับเรา</h3>
            </div>
            ...
            <div class="mt-2">
                ...
                <p class="mt-4 font-bold text-center section-title text-gray-600">ที่ปรึกษาโครงการวิจัย</p>
                ...
                <p class="mt-4 font-bold text-center section-title text-gray-600">ผู้พัฒนาเว็บไซต์</p>

                <div class="pr-3 pl-3 pb-2 pt-1 text-center">
                    <p class="name-text font-medium">นายณัฐพงศ์ พาเจริญ</p>
                    <p class="position-text">สาขาวิชาวิศวกรรมซอฟต์แวร์ สำนักวิชาเทคโนโลยีดิจิทัลประยุกต์ มหาวิทยาลัยแม่ฟ้าหลวง</p>
                </div>
                <div class="pr-3 pl-3 text-center">
                    <p class="name-text font-medium">นายสรัล ปรีชากรรม</p>
                    <p class="position-text">สาขาวิชาวิศวกรรมซอฟต์แวร์ สำนักวิชาเทคโนโลยีดิจิทัลประยุกต์ มหาวิทยาลัยแม่ฟ้าหลวง</p>
                </div>
            </div>
        </div>
