...
@section('content')
    ...
    <div id="puangun-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-3xl mx-4 max-w-sm w-full relative">
            <button onclick="closePuangunModal()" class="absolute top-4 right-4 w-8 h-8 flex items-center justify-center">
                <svg class="w-8 h-8 text-[#3E36AE]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            ...
            <div class="text-center mt-8 mb-8">
                ...
                <a href="https://apps.apple.com/th/app/%E0%B9%80%E0%B8%9E-%E0%B8%AD%E0%B8%99%E0%B8%81-%E0%B8%99-puangun/id6464116153?l=th" 
                   ...
                   class="block bg-[#929AFF] text-white rounded-2xl p-2 mb-6 hover:bg-[#8088FF] transition-colors ml-10 mr-10">
                    <div class="flex items-center justify-center space-x-8">
                        ...
                        <div class="text-left">
                            <div class="text-lg opacity-90">DOWNLOAD ON THE</div>
                            <div class="text-2xl font-semibold">APP STORE</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="https://play.google.com/store/apps/details?id=th.ac.mfu.puangun&pcampaignid=web_share" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   class="block bg-[#929AFF] text-white rounded-2xl p-2 hover:bg-[#8088FF] transition-colors mb-4 ml-10 mr-10">
                    <div class="flex items-center justify-center space-x-8">
                        <svg class="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                        </svg>
                        <div class="text-left">
                            <div class="text-lg opacity-90">ANDROID APP ON</div>
                            <div class="text-2xl font-semibold">GOOGLE PLAY</div>
                        </div>
                    </div>
                </a>
            </div>
