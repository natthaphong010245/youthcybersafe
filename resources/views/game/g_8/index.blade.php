...
@section('content')
    @include('game.intro', [
        ...
        'gameNumber' => '8',
        'description' => 'ผลกระทบของผู้รังแกกันทาง ไซเบอร์ จะเป็นอย่างไรบ้าง',
        'actionText' => 'เริ่มความก้าวหน้ากันเลย'
    ])

    <div class="card-container space-y-6 px-6 md:px-0" id="game-content">
        <div class="text-center mb-6">
            <h2 class="text-xl font-bold text-indigo-800 mb-4">น้อง ๆ คิดว่า ผลกระทบของผู้รังแกกันทาง ไซเบอร์
                จะเป็นอย่างไรบ้าง</h2>
            <p class="text-lg text-indigo-800 mt-2">เลือกรูปให้ตรงกับคำถามมากที่สุด</p>
        </div>

        <div class="space-y-4 mr-4 ml-4">
            <div class="choice-card correct-choice bg-white rounded-xl p-6 cursor-pointer transition-all border-2 border-transparent hover:border-indigo-200 mr-2 ml-2 mb-12"
                style="box-shadow: 0 0 15px rgba(0,0,0,0.2);">
                <div class="flex justify-center">
                    <img src="{{ asset('images/game/8/true.png') }}" alt="Emotional Impact"
                        class="w-80 h-48 object-contain">
                </div>
            </div>

            <div class="choice-card wrong-choice bg-white rounded-xl p-6 cursor-pointer transition-all border-2 border-transparent hover:border-indigo-200 mr-2 ml-2"
                style="box-shadow: 0 0 15px rgba(0,0,0,0.2);">
                <div class="flex justify-center">
    ...
    <div id="info-overlay" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-30 opacity-0">
        <div class="bg-white rounded-2xl shadow-xl p-6 max-w-md w-full mx-4 text-center">
            ...
            <div class="text-left space-y-2 mb-6 pr-4 pl-4">
                ...
                <p class="text-indigo-800"><span class="font-bold">2.</span> เผชิญกับภาวะวิตกกังวล หวาดระแวง รู้สึกไม่ปลอดภัย นอนไม่หลับ ภาวะซึมเศร้าและก็ฆ่าตัวตาย</p>
