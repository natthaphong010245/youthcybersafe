                    ...
                    <div class="bg-white w-full max-w-2xl mx-auto rounded-lg px-4 pt-4 flex flex-col pb-6">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="border-t border-gray-300 w-full pt-4">
                                ...
                                @if ($anxietyScore <= 3)
                                    <p class="text-green-600 font-medium mb-2 text-center">ระดับปกติ</p>
                                    <p class="text-gray-600 text-sm">ไม่มีความเสี่ยงที่จะเป็นภาวะวิตกกังวลนะ ดูแลตนเองดีมาก
                                        ๆ แล้วล่ะ ดูแลแบบนี้ต่อไปนะ</p>
                                @elseif ($anxietyScore <= 5)
                                    <p class="text-green-600 font-medium mb-2 text-center">ระดับเล็กน้อย</p>
                                    <p class="text-gray-600 text-sm">เริ่มเสี่ยงมีภาวะวิตกกังวล อาจจะลองดูแลตนเองให้มากขึ้น
                                        ฝึกการหายใจ 4-7-8 ก็ช่วยได้นะในเรื่องความกังวล หรือเทคนิค 5-4-3-2-1
                                        เพื่อช่วยดึงตัวเองออกจากความกังวล อย่าลืมนอนหลับพักผ่อนและดื่มน้ำเยอะ ๆ ล่ะ
                                        ถ้าหากต้องการพูดคุยสามารถปรึกษาผู้เชี่ยวชาญทางด้านจิตใจได้เช่นกัน
                                        อีกอย่างคือพิจารณาคะแนนอีกสองด้านด้วยนะว่าสูงหรือไม่</p>
                                @elseif($anxietyScore <= 7)
                                    <p class="text-yellow-600 font-medium mb-2 text-center">ระดับปานกลาง</p>
                                    <p class="text-gray-600 text-sm">เริ่มเสี่ยงมีภาวะวิตกกังวล อาจจะลองดูแลตนเองให้มากขึ้น
                                        ฝึกการหายใจ 4-7-8 ก็ช่วยได้นะในเรื่องความกังวล หรือเทคนิค 5-4-3-2-1
                                ...
                                @elseif($anxietyScore <= 9)
                                    <p class="text-orange-600 font-medium mb-2 text-center">ระดับรุนแรง</p>
                                    <p class="text-gray-600 text-sm">เสี่ยงมีภาวะวิตกกังวลสูงถึงสูงมาก
                                        หากพบว่าไม่สามารถใช้ชีวิตประจำวันแบบเดิมได้ ไม่อยากพูดคุยกับใคร
                                        ไม่อยากไปโรงเรียนเนื่องจากมีความกลัวหรือความกังวลบางอย่าง
                                        ควรพบผู้เชี่ยวชาญทางด้านจิตใจเพื่อรับการพูดคุยบำบัด หรือทานยาได้นะ
                                        อย่าลืมดูล่ะว่าคะแนนอีกสองด้านสูงเหมือนกันหรือเปล่า
                                    </p>
                                @else
                    ...
                    <div class="bg-white w-full max-w-2xl mx-auto rounded-lg px-4 pt-4 flex flex-col pb-6">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="border-t border-gray-300 w-full pt-4">
                                ...
                                @if ($depressionScore <= 4)
                                    <p class="text-green-600 font-medium mb-2 text-center">ระดับปกติ</p>
                                    <p class="text-gray-600 text-sm">ไม่มีความเสี่ยงที่จะเป็นภาวะซึมเศร้านะ ดูแลตนเองดีมาก
                                        ๆ แล้วล่ะ ดูแลแบบนี้ต่อไปนะ</p>
                                @elseif ($depressionScore <= 6)
                                    <p class="text-green-600 font-medium mb-2 text-center">ระดับเล็กน้อย</p>
                                    <p class="text-gray-600 text-sm">เริ่มมีความเสี่ยงเล็กน้อยถึงปานกลางที่จะมีภาวะซึมเศร้า
                                        อาจจะลองพิจารณาการดูแลตนเองอย่างใส่ใจมากขึ้น ทั้งการทานอาหาร การนอน
                                        การออกกำลังกายอย่างสม่ำเสมอ
                                        หากต้องการการพูดคุยที่เป็นประโยชน์สามารถปรึกษาผู้เชี่ยวชาญทางด้านจิตใจได้
                                        อย่าลืมดูคะแนนอีกสองด้านล่ะว่าได้เท่าไร</p>
                                @elseif($depressionScore <= 10)
                                    <p class="text-yellow-600 font-medium mb-2 text-center">ระดับปานกลาง</p>
                                    <p class="text-gray-600 text-sm">เริ่มมีความเสี่ยงเล็กน้อยถึงปานกลางที่จะมีภาวะซึมเศร้า
                                        อาจจะลองพิจารณาการดูแลตนเองอย่างใส่ใจมากขึ้น ทั้งการทานอาหาร การนอน
                                ...
                                @elseif($depressionScore <= 13)
                                    <p class="text-orange-600 font-medium mb-2 text-center">ระดับรุนแรง</p>
                                    <p class="text-gray-600 text-sm">เสี่ยงมีภาวะซึมเศร้าสูงถึงสูงมาก
                                        หากพบว่าไม่สามารถใช้ชีวิตประจำวันได้อย่างปกติ การนอนหลับ และการทานอาหารเปลี่ยนไป
                                        ไม่อยากพบใคร ไม่อยากไปโรงเรียนเนื่องจากไม่มีแรงจูงใจ
                                        ควรพบผู้เชี่ยวชาญทางด้านจิตใจเพื่อรับการพูดคุยบำบัด หรือทานยาได้นะ
                                        อย่าลืมดูล่ะว่าคะแนนอีกสองด้านสูงเหมือนกันหรือเปล่า</p>
                                @else
                                    <p class="text-red-600 font-medium mb-2 text-center">ระดับรุนแรงมาก</p>
                                    <p class="text-gray-600 text-sm">เสี่ยงมีภาวะซึมเศร้าสูงถึงสูงมาก
                                        หากพบว่าไม่สามารถใช้ชีวิตประจำวันได้อย่างปกติ การนอนหลับ และการทานอาหารเปลี่ยนไป
